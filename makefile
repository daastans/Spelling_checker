bin/scheck : main.o parser.o csvreporter.o xmlreporter.o commandline.o
	g++ bin/main.o bin/parser.o bin/csvreporter.o bin/xmlreporter.o bin/commandline.o -o bin/scheck
